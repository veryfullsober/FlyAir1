...
public class GameView extends SurfaceView implements Runnable {
    ...
    private void update () {
        ...
        for (Bullet bullet : bullets) {
            ...
            for (Shark shark : sharks) {
                ...
                if (Rect.intersects(shark.getCollisionShape(),
        ...
        for (Shark shark : sharks) {
            ...
            if (Rect.intersects(shark.getCollisionShape(), flight.getCollisionShape())) {
    ...
    private void draw () {
        ...
        if (getHolder().getSurface().isValid()) {
            ...
            for (Shark shark : sharks)
                canvas.drawBitmap(shark.getBird(), shark.x, shark.y, paint);
