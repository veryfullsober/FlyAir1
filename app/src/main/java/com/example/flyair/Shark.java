...
public class Shark {
    ...
    Shark(Resources res) {
        ...
        shark1 = BitmapFactory.decodeResource(res, R.drawable.shark1);
        shark2 = BitmapFactory.decodeResource(res, R.drawable.shark2);
        shark3 = BitmapFactory.decodeResource(res, R.drawable.shark3);
        shark4 = BitmapFactory.decodeResource(res, R.drawable.shark4);
